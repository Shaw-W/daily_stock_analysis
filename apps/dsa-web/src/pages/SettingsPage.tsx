          ...
          <section className="space-y-4">
            ...
            {activeCategory === 'system' ? (
              ...
              >
                ...
                >
                  <div className="rounded-lg border settings-border bg-background/40 px-4 py-3">
                ...
                {canCheckDesktopUpdate ? (
                  <div className="mt-4 space-y-3 rounded-lg border settings-border bg-background/30 px-4 py-4">
                    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                      <div>
